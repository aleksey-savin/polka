...
/**
 * Быстрый режим сканирования: успевают бесплатные каталоги, но не интернет.
 * Каталоги опрашиваются разом, поэтому им хватает таймаута самой медленной
 * ступени (6 с) плюс запас на добор обложки.
 */
